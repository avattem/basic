...
//                System.out.println("getIsTeamLead-->" + getIsTeamLead());
            ...
            try {
              ...
              //  System.out.println("getOverlaySavingAmount==>" + getOverlaySavingAmount());
                ...
                if (getFileFileName() != null) {
                    ...
                    String path=com.mss.mirage.util.Properties.getProperty("Attachments.Path")+"/"+"Emp Payroll/"+getFinancialYear()+ "/"+empId;
                    generatedPath = attachmentService.generatePath(path, "");
  ...
  if(Integer.parseInt(getOverLayExemptionType()) == 18){
             if (getRentEndDate() != null && !"".equals(getRentEndDate())) {
                 int count=DataSourceDataProvider.getInstance().isExistedTaxExemtion(Integer.parseInt(getEmpId()), getRentEndDate(), getOverLayExemptionType());
                 if(count>0){
...
if(getExemptionId() == 18){
             if (getRentEndDate() != null && !"".equals(getRentEndDate())) {
               int count=DataSourceDataProvider.getInstance().isExistedTaxExemtion(Integer.parseInt(getEmpId()), getRentEndDate(), getExemptionId()+"");
                 if(count>0){
                     responseString="existed";
                     temp=1;
                 }
