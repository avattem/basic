...
public class GreenSheetAction extends ActionSupport implements ServletRequestAware{
    ...
    public boolean saveFileToDisk(){
        ...
        File createPath=new File(Properties.getProperty("Attachments.PO.Path"));
        ...
        String weekName=cal.get(Calendar.WEEK_OF_MONTH)+" Week";
        
        /*getrequestType is used to create a directory of the object type specified in the jsp page*/
        createPath=new File(createPath.getAbsolutePath()+"//MirageV2//"+getRequestType()+"//"+String.valueOf(cal.get(Calendar.YEAR))+"//"+month+"//"+weekName);
        //System.err.println("Absolute path:"+createPath);
