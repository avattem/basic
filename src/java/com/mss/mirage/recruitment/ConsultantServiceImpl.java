    ...
    public int doAddConsultant(ConsultantAction consultantAction) throws ServiceLocatorException {
        ...
        try{
            ...
            /*preStmt = connection.prepareStatement("INSERT INTO tblRecConsultant(Id,FName,LName,MName,Email2,TitleTypeId,Gender," +
                    ...
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); */
            preStmt.setInt(1,id);
            preStmt.setString(2,consultantAction.getFiName());
            preStmt.setString(3,consultantAction.getLaName());
            preStmt.setString(4,consultantAction.getMiName());
            preStmt.setString(5,consultantAction.getEmail2());
            preStmt.setString(6,consultantAction.getTitleTypeId());
            preStmt.setString(7,consultantAction.getGender());
            preStmt.setString(8,consultantAction.getWorkPhoneNo());
            preStmt.setString(9,consultantAction.getHomePhoneNo());
            preStmt.setString(10,consultantAction.getCellPhoneNo());
            preStmt.setString(11,consultantAction.getWorkAuthorization());
            preStmt.setString(12,consultantAction.getSkills());
            preStmt.setString(13,consultantAction.getPracticeId());
            preStmt.setString(14,consultantAction.getCountry());
            preStmt.setString(15,consultantAction.getRefferedBy());
            preStmt.setString(16,consultantAction.getRatePerHour());
            preStmt.setString(17,consultantAction.getComments());
            preStmt.setString(18,"Attachment");
            preStmt.setString(19,consultantAction.getCreatedBy());
            preStmt.setString(20,consultantAction.getIndustryId());
         
            
            
            if(consultantAction.getSource().equals("")) {
                preStmt.setString(21,null);
            }else {
                preStmt.setString(21,consultantAction.getSource());
            }
            ...
            preStmt.setTimestamp(22,consultantAction.getDate());
            preStmt.setDate(23,consultantAction.getAvailableFrom());
            preStmt.setString(24,consultantAction.getDescription());
            
               String resorg = consultantAction.getOrg();
            if(resorg.equals(""))
            {
                preStmt.setString(25,"1USA");
            }
            else
            {
             preStmt.setString(25,consultantAction.getOrg());
            }
            ...
            preStmt.setString(26,consultantAction.getExp());
            preStmt.setString(27,consultantAction.getTechEval());
            preStmt.setString(28,consultantAction.getAvailable());
            preStmt.setString(29,consultantAction.getPreferredState());
            isSuccess = preStmt.executeUpdate();
            
            
            consultantAction.setObjectId(objId);
           // preStmt.close();
           // preStmt=null;
           // connection.close();
           // connection=null;
    ...
    public int newAttachResume(ConsultantAction consultantAction) throws ServiceLocatorException{
        ...
        try {
            ...
            // consultantAction.setDate(new Timestamp(new java.util.Date().getTime()));
             ...
             preStmt = connection.prepareStatement("INSERT INTO tblRecAttachments(Id,ObjectId,ObjectType,AttachmentName,AttachmentFileName,AttachmentLocation,DateUploaded) values(?,?,?,?,?,?,?)");
             preStmt.setInt(1,Id);
             preStmt.setInt(2,consultantAction.getObjectIdinInt());
             preStmt.setString(3,consultantAction.getRequestType());
             preStmt.setString(4,consultantAction.getAttachmentName());
             preStmt.setString(5,consultantAction.getUploadFileName());
             preStmt.setString(6,consultantAction.getFilepath());
             preStmt.setTimestamp(7,consultantAction.getDate());
...
//                preStmt.setInt(11,taskId);
   ...
   public String getReviewConsultantDetails(ConsultantAction consultantAction,int consultantId) throws ServiceLocatorException{
        ...
        queryString = "SELECT CONCAT(FName,' ' ,MName,' ',LName) AS NAME,Email2 AS Email,CellPhoneNo AS Mobile,"
                + " TitleTypeId AS Title FROM tblRecConsultant WHERE Id ="+consultantId;
        ConsultantVTO consultantVTO = new ConsultantVTO();
        Statement statement=null;
...
//                    + "Comments,LastModifiedDate,Rateing,LinkStatus,ForwardedLink,Presales2,Status,RequirementId,RecConsultantId,ScheduledDate,ScheduledTime,TimeFormat,Zone,TechieTitle,Skill1,Skill2,Skill3,Skill4,Skill5,Skill6,Skill7,Skill8,Skill9,Skill10,InterveiwType) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
  preStmt = connection.prepareStatement("INSERT INTO tblRecConsultantActivity(ConsultantId,ForwardedBy,Presales1,ForwardedDate,"
                    + "Comments,Rateing,LinkStatus,ForwardedLink,Presales2,Status,RequirementId,RecConsultantId,ScheduledDate,ScheduledTime,TimeFormat,Zone,TechieTitle,Skill1,Skill2,Skill3,Skill4,Skill5,Skill6,Skill7,Skill8,Skill9,Skill10,InterveiwType) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
         ...
         htmlText.append("<tr>");
            htmlText.append("<td bgcolor='#ffffff' align='center' style='padding: 15px 0px;'>");
                        ...
                        htmlText.append("<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center' style='max-width: 500px;' class='responsive-table'>");
                           ...
                           htmlText.append("</tr>");
                           htmlText.append("<tr>");
                              htmlText.append("<td align='center' style='font-size: 14px; line-height: 20px; font-family: calibri; color:#666666;'>&copy; 2016 Miracle Software Systems<br></td>");
                           htmlText.append("</tr>");
                        htmlText.append("</table>");
