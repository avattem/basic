            ...
            if(AuthorizationManager.getInstance().isAuthorizedUser("INPUT_RECRUITMENT_ATTACHMENT",userRoleId)){
                try{
                    if(!("dbGrid".equalsIgnoreCase(getSubmitFrom()))){
                        ...
                        String month="";
                        if(dt.getMonth()==0) month="Jan";
                        else if(dt.getMonth()==1) month="Feb";
                        else if(dt.getMonth()==2) month="Mar";
                        else if(dt.getMonth()==3) month="Apr";
                        else if(dt.getMonth()==4) month="May";
                        else if(dt.getMonth()==5) month="Jun";
                        else if(dt.getMonth()==6) month="Jul";
                        else if(dt.getMonth()==7) month="Aug";
                        else if(dt.getMonth()==8) month="Sep";
                        else if(dt.getMonth()==9) month="Oct";
                        else if(dt.getMonth()==10) month="Nov";
                        else if(dt.getMonth()==11) month="Dec";
                        ...
                        createPath=new File(createPath.getAbsolutePath()+"//MirageV2//"+getRequestType()+"//"+String.valueOf(dt.getYear()+1900)+"//"+month+"//"+String.valueOf(week));
            ...
            if(AuthorizationManager.getInstance().isAuthorizedUser("RESUME_SUBMITT_RECRUITMENT_ATTACHMENT",userRoleId)){
                try{
                    ...
                    if(!("dbGrid".equalsIgnoreCase(getSubmitFrom()))){
                        ...
                        /*The path which is created in the drive and used as a home directroy*/
                        String basePath = Properties.getProperty("Resume.Download");
                        File createPath=new File(basePath);
                        Date dt=new Date();
                        /*The month is generated from her*/
                        String month="";
            ...
            if(AuthorizationManager.getInstance().isAuthorizedUser("CONSULTANT_TECHREVIEW_RECRUITMENT_ATTACHMENT",userRoleId)){
                try{
                    if(!("dbGrid".equalsIgnoreCase(getSubmitFrom()))){
                        ...
                        /*The path which is created in the drive and used as a home directroy*/
                        String basePath =  Properties.getProperty("Consultant.Reviews");
                        File createPath=new File(basePath);
                        Date dt=new Date();
                        /*The month is generated from her*/
                        String month="";
