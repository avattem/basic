...
private String pfno;
    ...
    public void renderImage() {
        ...
        try {
            ...
            if(getEmpId() == null) {
                rs = statement.executeQuery("select Image from tblEmployee where LoginId='"+httpServletRequest.getSession(false).getAttribute(ApplicationConstants.SESSION_USER_ID)+"'");
            }else {
                rs = statement.executeQuery("select Image from tblEmployee where Id='"+getEmpId()+"'");
            }
            rs.next();
