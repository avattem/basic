                ...
                <table align="center" border="0" cellspacing="0" style="width:100%;">
                    <tr>                               
                      ...
                      <tr><td><table style="width:100%;" align="center" border="0">
                                  <tr>
                                       <td   class="fieldLabel">Select EmpName :<font style="color:red;">*</font></td>
                                                      <td ><s:select list="empnamesList" id="userId" name="userId" headerKey="-1" headerValue="--Please Select--" cssClass="inputSelectLarge"/></td> 
             ...
             <td class="fieldLabel" >Type of Reviews :<FONT color="red"  ><em>*</em></FONT> </td>
                                     ...
                                     <tr>
                                          <td class="fieldLabel">Review Name :<font style="color:red;">*</font></td>
                                                    <td colspan="3"><s:textfield name="overlayReviewName" id="overlayReviewName" cssClass="inputTextareaOverlay1" value="%{currentReview.reviewName}" onchange="reviewFieldLengthValidator(this);"/></td>
                                     </tr>
                                   <tr>
                                    ...
                                    --%>
                                     ...
                                     <tr>
                                         <td class="fieldLabel" valign="top">Description :</td>
                                                    <td colspan="3" valign="top"><s:textarea rows="3" cols="65" name="overlayDescription" cssClass="inputTextareaOverlay1" value="%{currentReview.notes}" onchange="reviewFieldLengthValidator(this);" id="overlayDescription"/></td>
                                                 </tr>
                                                    
                                                 <tr id="tlcommentsTr" >
                                         <td class="fieldLabel" valign="top">Lead Comments :</td>
                                                    <td colspan="3" valign="top"><s:textarea rows="3" cols="65" name="tlComments" cssClass="inputTextareaOverlay1" value="%{currentReview.notes}" onchange="reviewFieldLengthValidator(this);" id="tlComments"/></td>
                                                 </tr>
                                                 <tr>
                                                      <td class="fieldLabel" >State :<FONT color="red"  ><em>*</em></FONT> </td>
                                         ...
                                         <td class="fieldLabel" valign="top">Hr Comments :</td>
                                                    <td colspan="3" valign="top"><s:textarea rows="3" cols="65" name="hrComments" cssClass="inputTextareaOverlay1" value="%{currentReview.notes}" onchange="reviewFieldLengthValidator(this);" id="hrComments"/></td>
                                                 </tr>
                                                 <tr id="hrratingsTr">
                                                      <td class="fieldLabel">State&nbsp;:<FONT color="red"  ><em>*</em></FONT> </td>
                                         ...
                                         <td class="fieldLabel" valign="top">OnsiteMgr&nbsp;Comments :</td>
                                                    <td colspan="3" valign="top"><s:textarea rows="3" cols="65" name="onsiteMgrComments" cssClass="inputTextareaOverlay1" value="%{currentReview.notes}" onchange="reviewFieldLengthValidator(this);" id="onsiteMgrComments"/></td>
                                                 </tr>
                                                 <tr id="onsiteMgrratingsTr">
                                                  ...
                                                  <!-- onsite mgr comments end -->
                                                    ...
                                                    <td  align="left" >
                                                        <input type="button" value="Save" onclick="return ajaxFileUpload();" class="buttonBg" id="addButton"/> 
                                                ...
                                                <tr style="display: none" id="downloadTr">
                                                          ...
                                                          <span id="downloadFile"></span>
                                                                </a></td><td> <input type="button" value="Update" onclick="return upadtereview('1');" class="buttonBg"/> 
                                                </tr>      
                              </table>
                          </td></tr>
            </table>
                                                    ...
                                                    <table cellpadding="1" cellspacing="1" border="0" width="650px" align="center">
                                                        ...
                                                        <tr>
                                                         ...
                                                         <%--   <td class="fieldLabel" >State :<FONT color="red"  ><em>*</em></FONT> </td>
                                                          ...
                                                          --%>
                                                       <td class="fieldLabel" >TL State :<FONT color="red"  ><em>*</em></FONT> </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <% if(session.getAttribute(ApplicationConstants.SESSION_ROLE_NAME).toString().equalsIgnoreCase("Operations")) {%>
                                                             <td class="fieldLabel" >HR State :<FONT color="red"  ><em>*</em></FONT> </td>
                                       ...
                                       <grd:dbgrid id="tblStat" name="tblStat" width="98" pageSize="10"
                                                                ...
                                                                <%--    <grd:gridpager imgFirst="../../includes/images/DBGrid/First.gif" imgPrevious="../../includes/images/DBGrid/Previous.gif" 
                                                                 ...
                                                                 <%--  <grd:anchorcolumn dataField="EmployeeName" 
                                                                    ...
                                                                    <grd:textcolumn dataField="Status" headerText="State" width="18"/> 
                                                                ...
                                                                dataMember="<%=queryString%>" dataSource="<%=connection%>" cssClass="gridTable">
                                                                 ...
                                                                 <%--  <grd:anchorcolumn dataField="EmployeeName" 
                                                                  ...
                                                                  <grd:anchorcolumn dataField="EmployeeName" 
                                                                    ...
                                                                    <grd:textcolumn dataField="Status" headerText="TL State" width="18"/> 
                                                                    <grd:textcolumn dataField="HRStatus" headerText="HR State" width="18"/> 
                                                                    <grd:datecolumn dataField="ReviewDate"  headerText="ReviewDate"  dataFormat="MM-dd-yyyy" width="15" /> 
