       ...
       if(element.value=="0")
           {
            ...
            $("#projectsSelectBox").hide(); $("#projectsAttachBox").hide(); 
                                    ...
                                    <table cellpadding="0" border="0" cellspacing="0" width="100%">
                                        <tr align="right">
                                            <td class="headerText12" colspan="5" >
                                             ...
                                             <td class="fieldLabel">Task&nbsp;Related&nbsp;to:</td> 
                                                    ...
                                                    <s:form action="../tasks/newAddTask.action" method="post" theme="simple" enctype="multipart/form-data" onsubmit="return taskValidation();">
                                                        ...
                                                        <table cellpadding="1" cellspacing="1" border="0" width="70%">
                                                                ...
                                                                <td colspan="4">
                                                                    <div id="projectsSelectBox" align="left" style="margin-left: 9%;" >
                                                                        ...
                                                                        <table >
                                                                            ...
                                                                            <tr>
                                                                                  <td class="fieldLabel">Attachment:</td>
                                                                                <td colspan="" ><s:file name="upload" theme="simple" size="60" cssClass="inputTextareaForAttachmentTitle" id="uploadFileName" onchange="validateFileSize(this);attachmentFileNameValidate();" /></td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr> <td class="fieldLabel">Type :<FONT color="red"><em>*</em></FONT></td> 
                                                                ...
                                                                <td style="padding-left: 8px;"><s:select id="priority" name="priority"  list="{'High','Medium','Low'}" value="%{currentTask.priority}" cssClass="inputSelect"/></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="fieldLabel">Title:</td>
                                                                <td colspan="3"><s:textfield cssClass="inputTextBlueForIssueTitle" name="title" style="width:412px;" id="title" value="%{currentTask.title}" readonly="false" onchange="fieldLengthValidator(this);"  /></td>
                                                            </tr>  
                                                            <tr>
                                                                ...
                                                                <td class="userInfoLeft">
                                                                    <s:textfield name="secondaryAssignTo" cssClass="inputTextBlue" id="secondaryAssignTo" onkeyup="getAllEmpNames();" value="%{currentTask.secondaryAssignTo}" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td >
                                                                    <s:textfield name="durationTotheTask" cssClass="inputTextBlue2" style="width:48px;" id="durationTotheTask"  value="%{currentTask.durationTotheTask}" onkeypress="return isNumber(event)"/><s:label cssClass="fieldLabel" value="(Hrs)"/>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3"><s:textarea rows="4" cols="65" name="comments" cssClass="inputTextarea2" id="comments" value="%{currentTask.comments}" onchange="fieldLengthValidator(this);"/></td>
                                                            </tr> 
