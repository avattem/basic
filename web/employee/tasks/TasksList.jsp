                    ...
                    <table class="innerTable1000x515" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:5px 5px;">
                                ...
                                <div  style="border:1px solid gray; width: 857px;height: 696px; overflow:auto; margin-bottom: 1em;">
                                    <!--//START TAB : -->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <s:if test="#session.isUserManager == 1 || #session.isUserTeamLead==1">     
                                                                <grd:dbgrid id="tblCrmAttachments" name="tblCrmAttachments" width="100" pageSize="22" 
                                                                    ...
                                                                    <grd:datecolumn dataField="CreatedDate"  headerText="CreatedDate"  dataFormat="MM-dd-yyyy" width="8" sortable="true"/>
                                                                    <grd:datecolumn dataField="DueDate"  headerText="DueDate"  dataFormat="MM-dd-yyyy" width="8" sortable="true"/>
                                              ...
                                              <%--  <tr>
                                                ...
                                                <tr><td align="left"> <table>
                                                    <%-- Issue name based search  --%>
                                                            ...
                                                            <tr>
                                                            <!--<td class="fieldLabel">TaskId:</td>
                                                            <td width="20%"><%--<s:textfield name="taskId" id="taskId"  cssClass="inputTextBlue"  value="%{currentIssue.taskId}"  theme="simple"/>--%></td> -->
                                                            <td  class="fieldLabel">IssueRel:</td>
                                                              <td ><s:select id="issueRelType" name="issueRelType" headerKey="-1" headerValue="--Please Select--" list="#@java.util.LinkedHashMap@{'0':'HR','1':'Hubble','2':'Projects','3':'Systems','4':'Facilities'}" value="%{currentIssue.issueRelType}" cssClass="inputSelect" onchange="getAssignedToBasedOnIssueType(this);"/></td>
                                                            </tr> 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="40%"><s:textfield name="startDate" value="%{startDate}" id="startDate" cssClass="inputTextBlue"/><a href="javascript:cal1.popup();" style="text-decoration: none;">
                                                                    <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                     width="20" height="20" border="0"></a></td>
                                                                <td class="fieldLabel">End Date:</td>
                                                                <td><s:textfield name="endDate" id="endDate" value="%{endDate}" cssClass="inputTextBlue"/><a href="javascript:cal2.popup();" style="text-decoration: none;">
                                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                     width="20" height="20" border="0"></a></td>
...
%>                                
                    ...
                    <td width="200px">  
                        <s:textfield name="customerName" id="customerName"   cssClass="inputTextBlue"  value="%{currentTask.customerName}"  theme="simple" onkeyup="fillCustomerInIssue();"/>
                        <div id="validationMessage"></div>
                        <s:hidden name="customerId" value="%{currentTask.customerId}" id="customerId"/> 
                    </td>
                   
                        <td width="1px" class="fieldLabel">Project&nbsp;Name&nbsp;: </td>
                        <td>
