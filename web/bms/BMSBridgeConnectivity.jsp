                                                ...
                                                <s:form name="frmbmsBridgeSearch" action="bridgeSearch.action" theme="simple">
                                                    ...
                                                    <table cellpadding="1" cellspacing="1" border="0" width="650px" align="center">
                                                        <tr>
                                                            ...
                                                            <td><s:textfield name="bridgeCode" id="bridgeCode" cssClass="inputTextBlueSmall" value="%{bridgeCode}"/>
                                                            ...
                                                            <td width="100%">
                                                                ...
                                                                dataMember="<%=queryString%>" dataSource="<%=connection%>" cssClass="gridTable">
                                                                    ...
                                                                    <grd:anchorcolumn dataField="BCode" 
                                                                                      ...
                                                                                      linkUrl="javascript:toggleEditOverlayForBmsBridge('{BCode}')" linkText="{BCode}" width="20"/>
                                                                    <grd:textcolumn dataField="BNumber" headerText="Bridge Number" width="18"/>
                                                                    <grd:datecolumn dataField="PassCode" headerText="PassCode" width="18"/>
                                                                    <grd:textcolumn dataField="BName" headerText="Bridge Name" width="18"/> 
                                                                     ...
                                                                     <grd:datecolumn dataField="CreatedDate" headerText="Created&nbsp;Date"  width="16"  dataFormat="MM-dd-yyyy" />
