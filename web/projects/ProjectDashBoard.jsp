                        ...
                        <tr>
                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding-left:10px;padding-top:5px;">
                                ...
                                <ul id="accountTabs" class="shadetabs" >
                                    <li><a href="#" rel="accountsListTab" class="selected"> Project Team DashBoard</a></li>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="25%">
                                                                                                <%--   <s:select list="myAccounts" name="accountId" id="customerId" onchange="getProjectsForAccountId();hidePriority();" headerKey="-1" headerValue="--Select Project--" cssClass="inputLargeSelect" value="" disabled="false"/>  --%>
                                                                                                   <s:select list="myAccounts" name="accountId" id="customerId" onchange="getMyProjectsByAccountId();hidePriority();" headerKey="-1" headerValue="--Select Project--" cssClass="inputLargeSelect" value="" disabled="false"/> 
                                                                                            </td>
                                                                                            
                                                                                            <td class="fieldLabel">Projects: </td>

                                                                                            <td width="25%">
                                                                                                   <s:select list="myProjects" name="projectId" id="projectId" onchange="hidePriority();" headerKey="-1" headerValue="--Select Project--" cssClass="inputLargeSelect" value="" disabled="false"/> 
                                                                                            </td>
                                                                                           
                                                                                           
                                                                                            <%-- <td style="padding-left:0px;"><input type="button" value="Search"  class="buttonBg"  onclick="getAccountsByPriority();"/></td> --%>
                                                                                            <td style="padding-left:0px;"><input id="normalUserButton" type="button" value="Search"  class="buttonBg"  onclick="getProjectTeam();"/></td>
