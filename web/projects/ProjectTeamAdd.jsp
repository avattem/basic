            ...
            function checkProjectTeamForm()
            {
               ...
               if(parseInt(util) == 0 && status=='Active') {
                ...
                if(utilisation != 0 || utilisation != ""){
                    ...
                    alert("utilisation field cannot be empty");
                    return false;
                }
 ...
 <!-- Inactive reason overlay Start -->
                                 <div id="overlay"></div> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><s:textfield name="endDate" id="endDate" value="%{dateClosed}" cssClass="inputTextBlue"/><a href="javascript:cal3.popup();"><img style="margin-bottom: -6px" src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif"
                                                ...
                                                <table width="100%" cellpadding="2" cellspacing="2" border="0" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <s:if test="%{currentAction == 'doAddProjectTeam'}">
                                                            ...
                                                            <td ><s:textfield name="assignedToUID" id="assignedToUID" value="%{assignedToUID}" onchange="checkName();"  onkeyup="fillEmployeeForProject();"  cssClass="inputTextBlue"  theme="simple" readonly="false"/>
                                                            </s:if>
                                                            <s:else>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  width="30%">
                                                            ...
                                                            <s:textfield name="dateClosed" id="dateClosed" value="%{dateClosed}" cssClass="inputTextBlue"/><a href="javascript:cal2.popup();"><img style="margin-bottom: -6px" src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif"
                                                                                                    width="20" height="20" border="0"></a>
                                                        </td>
                    ...
                    cal3.time_comp = false;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><s:checkbox   id="checkAlert"  name="isBillable" value="%{isBillable}"/></td>
                                                    </tr>
                                                    <%--  <tr>
...
<td colspan="3"><s:textarea id="skillSet" cssClass="inputTextarea" onchange="fieldLengthValidator(this);"  cols="88" value="%{skillSet}"  name="skillSet" /></td>
</tr>
<tr>
<td class="fieldLabel" id="commentsField"> Comments :</td>
<td colspan="3"><s:textarea id="comments" cssClass="inputTextarea" onchange="fieldLengthValidator(this);"  cols="100" value="%{comments}"  name="comments" /></td>
</tr>
                                                    </tr>
