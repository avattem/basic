...
function checkAddLeads()
{
    ...
    if(title=="" || description=="" || title==null || description==null || investmentId.trim().length=="" || contactsHidden.trim().length=="")
    {
        alert("plz fill Title, Description,Contacts and Investment");
        return false;
