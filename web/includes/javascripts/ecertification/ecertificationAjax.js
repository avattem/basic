...
{
 window.location="../ecertification/generateExcelReportForKeys.action?practiceId="+practice+"&topicId="+topic;
 return true;
}
 ...
 function getExamReport(){
    ...
    if(startDate.length == 0 && startDate.length == 0)
    {
        ...
        window.location = "generateExamReport.action?startDate="+startDate+"&endDate="+endDate+"&empType="+empType+"&empName="+empName+"&consultantId="+consultantId+"&loginId="+loginId;
    }
