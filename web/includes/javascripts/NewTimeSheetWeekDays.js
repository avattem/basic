...
// for checking the null valus
 ...
 function computeProj1(td){
          ...
          function maxExceedde(td){
               ...
               function sumSun(){
              var sum=Number(document.frmAddTimeSheet.proj1Sun.value) +  Number(document.frmAddTimeSheet.proj2Sun.value) + Number(document.frmAddTimeSheet.internalSun.value) + Number(document.frmAddTimeSheet.vacationSun.value)+ Number(document.frmAddTimeSheet.holiSun.value)+ Number(document.frmAddTimeSheet.compSun.value) +  Number(document.frmAddTimeSheet.proj3Sun.value) +  Number(document.frmAddTimeSheet.proj4Sun.value)+  Number(document.frmAddTimeSheet.proj5Sun.value)  ;
                return sum;
              }
              function sumMon(){
              var sum=Number(document.frmAddTimeSheet.proj1Mon.value) +  Number(document.frmAddTimeSheet.proj2Mon.value) + Number(document.frmAddTimeSheet.proj3Mon.value)+ Number(document.frmAddTimeSheet.proj4Mon.value)+Number(document.frmAddTimeSheet.proj5Mon.value)+  Number(document.frmAddTimeSheet.internalMon.value) + Number(document.frmAddTimeSheet.vacationMon.value)+ Number(document.frmAddTimeSheet.holiMon.value)+ Number(document.frmAddTimeSheet.compMon.value);
                return sum;
              }
               function sumTus(){
              var sum=Number(document.frmAddTimeSheet.proj1Tus.value) +  Number(document.frmAddTimeSheet.proj2Tus.value)+  Number(document.frmAddTimeSheet.proj3Tus.value)+  Number(document.frmAddTimeSheet.proj4Tus.value)+  Number(document.frmAddTimeSheet.proj5Tus.value) + Number(document.frmAddTimeSheet.internalTus.value) + Number(document.frmAddTimeSheet.vacationTus.value)+ Number(document.frmAddTimeSheet.holiTus.value)+ Number(document.frmAddTimeSheet.compTus.value);
                return sum;
              }
            function sumWed(){
              var sum=Number(document.frmAddTimeSheet.proj1Wed.value) +  Number(document.frmAddTimeSheet.proj2Wed.value) +  Number(document.frmAddTimeSheet.proj3Wed.value)+  Number(document.frmAddTimeSheet.proj4Wed.value)+  Number(document.frmAddTimeSheet.proj5Wed.value)+ Number(document.frmAddTimeSheet.internalWed.value) + Number(document.frmAddTimeSheet.vacationWed.value)+ Number(document.frmAddTimeSheet.holiWed.value)+ Number(document.frmAddTimeSheet.compWed.value) ;
                return sum;
              }
            function sumThur(){
              var sum=Number(document.frmAddTimeSheet.proj1Thur.value) +  Number(document.frmAddTimeSheet.proj2Thur.value)+  Number(document.frmAddTimeSheet.proj3Thur.value)+  Number(document.frmAddTimeSheet.proj4Thur.value)+  Number(document.frmAddTimeSheet.proj5Thur.value) + Number(document.frmAddTimeSheet.internalThur.value) + Number(document.frmAddTimeSheet.vacationThur.value)+ Number(document.frmAddTimeSheet.holiThur.value)+ Number(document.frmAddTimeSheet.compThur.value);
                return sum;
              }
            function sumFri(){
              var sum=Number(document.frmAddTimeSheet.proj1Fri.value) +  Number(document.frmAddTimeSheet.proj2Fri.value)+  Number(document.frmAddTimeSheet.proj3Fri.value) +  Number(document.frmAddTimeSheet.proj4Fri.value) +  Number(document.frmAddTimeSheet.proj5Fri.value)  + Number(document.frmAddTimeSheet.internalFri.value) + Number(document.frmAddTimeSheet.vacationFri.value)+ Number(document.frmAddTimeSheet.holiFri.value) + Number(document.frmAddTimeSheet.compFri.value);
                return sum;
              }
          function sumSat(){
              var sum=Number(document.frmAddTimeSheet.proj1Sat.value) +  Number(document.frmAddTimeSheet.proj2Sat.value)+  Number(document.frmAddTimeSheet.proj3Sat.value) +  Number(document.frmAddTimeSheet.proj4Sat.value) +  Number(document.frmAddTimeSheet.proj5Sat.value)  + Number(document.frmAddTimeSheet.internalSat.value) + Number(document.frmAddTimeSheet.vacationSat.value)+ Number(document.frmAddTimeSheet.holiSat.value)+ Number(document.frmAddTimeSheet.compSat.value) ;
                return sum;
              }
          ...
          function checkSat(td){
             ...
             function proj3Total(){
                document.frmAddTimeSheet.proj3TotalHrs.value=Number(document.frmAddTimeSheet.proj3Sun.value) +  Number(document.frmAddTimeSheet.proj3Mon.value) + Number(document.frmAddTimeSheet.proj3Tus.value) + Number(document.frmAddTimeSheet.proj3Wed.value)+ Number(document.frmAddTimeSheet.proj3Thur.value)+ Number(document.frmAddTimeSheet.proj3Fri.value) +Number(document.frmAddTimeSheet.proj3Sat.value); 
             }
             function proj4Total(){
                document.frmAddTimeSheet.proj4TotalHrs.value=Number(document.frmAddTimeSheet.proj4Sun.value) +  Number(document.frmAddTimeSheet.proj4Mon.value) + Number(document.frmAddTimeSheet.proj4Tus.value) + Number(document.frmAddTimeSheet.proj4Wed.value)+ Number(document.frmAddTimeSheet.proj4Thur.value)+ Number(document.frmAddTimeSheet.proj4Fri.value) +Number(document.frmAddTimeSheet.proj4Sat.value); 
             }
             function proj5Total(){
                document.frmAddTimeSheet.proj5TotalHrs.value=Number(document.frmAddTimeSheet.proj5Sun.value) +  Number(document.frmAddTimeSheet.proj5Mon.value) + Number(document.frmAddTimeSheet.proj5Tus.value) + Number(document.frmAddTimeSheet.proj5Wed.value)+ Number(document.frmAddTimeSheet.proj5Thur.value)+ Number(document.frmAddTimeSheet.proj5Fri.value) +Number(document.frmAddTimeSheet.proj5Sat.value); 
             }
     ...
     function holiTotal(){
      ...
      function compTotal(){
               document.frmAddTimeSheet.compTotalHrs.value =Number(document.frmAddTimeSheet.compSun.value) +  Number(document.frmAddTimeSheet.compMon.value) + Number(document.frmAddTimeSheet.compTus.value) + Number(document.frmAddTimeSheet.compWed.value)+ Number(document.frmAddTimeSheet.compThur.value)+ Number(document.frmAddTimeSheet.compFri.value) +Number(document.frmAddTimeSheet.compSat.value); 
             }
       function sumOfBillingHours() {
          document.frmAddTimeSheet.totalBillHrs.value=Number(document.frmAddTimeSheet.proj1TotalHrs.value)+Number(document.frmAddTimeSheet.proj2TotalHrs.value)+Number(document.frmAddTimeSheet.proj3TotalHrs.value)+Number(document.frmAddTimeSheet.proj4TotalHrs.value)+Number(document.frmAddTimeSheet.proj5TotalHrs.value)+Number(document.frmAddTimeSheet.internalTotalHrs.value);
          ...
          document.frmAddTimeSheet.totalComptimeHrs.value=document.frmAddTimeSheet.compTotalHrs.value;
