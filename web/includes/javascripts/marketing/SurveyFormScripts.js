  ...
  var currentStatus=document.getElementById("QuestionnaireStatus").value;
    ...
    if(questionTitle.trim().length==0){
        ...
        $.ajax({
            ...
            "&optionSequence1="+optionSequence1+"&optionSequence2="+optionSequence2+"&optionSequence3="+optionSequence3+"&optionSequence4="+optionSequence4+"&optionSequence5="+optionSequence5+"&optionSequence6="+optionSequence6+"&isRequired="+isRequired+"&dropdownOptions="+dropdownOptions+"&questionStatus="+currentStatus+"&allowDocuments="+isAllowDocuments+"&allowPictures="+isAllowPictures,
 ...
 var isAllowDocuments=document.getElementById("allowDocuments").checked;
    ...
    }else
    {
        ...
        $.ajax({
            ...
            +"&optionLabel1="+encodeURIComponent(optionLabel1)+"&optionLabel2="+encodeURIComponent(optionLabel2)+"&optionLabel3="+encodeURIComponent(optionLabel3)+"&optionLabel4="+encodeURIComponent(optionLabel4)+"&optionLabel5="+encodeURIComponent(optionLabel5)+"&optionLabel6="+encodeURIComponent(optionLabel6)+
            "&optionSequence1="+optionSequence1+"&optionSequence2="+optionSequence2+"&optionSequence3="+optionSequence3+"&optionSequence4="+optionSequence4+"&optionSequence5="+optionSequence5+"&optionSequence6="+optionSequence6+"&isRequired="+isRequired+"&dropdownOptions="+dropdownOptions+"&allowDocuments="+isAllowDocuments+"&allowPictures="+isAllowPictures,
            context: document.body,
            success: function(responseText) {
