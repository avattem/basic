...
//            alert("myTasks")
     ...
     else if(action=="empCalendar") //Calendar
    {
     ...
     else if(action=="projectDashBoard") //Projects Dashboard
    {
             
        document.getElementById("myDisplay").style.display="block";    
        document.getElementById("myProjectDashboard").style.color="#FFFF00"; 
        document.getElementById("myProjectDashboard").style.fontWeight="bold"; 
        document.getElementById("myAdmin").style.background = "url("+CONTENXT_PATH+"/includes/images/menu/icon_minus.png ) 96% center no-repeat ";
    } 
    ...
    else if(action=="getCustomerProjectsList") //PMO Activity
    {
     ...
     else if(action=="pmoDashBoard") //PMO Dashboard
    {
             
        document.getElementById("myDisplay").style.display="block";    
        document.getElementById("mypmoDashBoard").style.color="#FFFF00"; 
        document.getElementById("mypmoDashBoard").style.fontWeight="bold"; 
        document.getElementById("myAdmin").style.background = "url("+CONTENXT_PATH+"/includes/images/menu/icon_minus.png ) 96% center no-repeat ";
    } 
