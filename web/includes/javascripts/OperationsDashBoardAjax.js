 ...
 function getProjectSheets()
{
 ...
 var ActiveProjectFlag=document.getElementById('ActiveProjects').checked;
...
function getProjectDetailsByCustomer()
{
    ...
    var url = CONTENXT_PATH+"/getEmployeesBasedOnCustomer.action?accountId="+accountId+"&projectId="+projectId;
  ...
  //  var state=document.getElementById("state").value;
    ...
    if(dataArray == "no data")
    {
        alert("No Records Found for this Search");   
            ...
            var headerFields = new Array("S.No","Resource&nbsp;Name","Status","Role","Country","Project&nbsp;Start&nbsp;date","Project&nbsp;End&nbsp;date","Billable","Utilization");
        //generateHeader(headerArray,tableId);
...
//            cell.innerHTML = "<a href='javascript:getEmployeeDetails("+fields[0]+")'>"+fields[i]+"</a>";
//        }
//      if(state=="Available" || state=="OnProject")
//        {
//            if(parseInt(i,10)==9){
//                cell.innerHTML = "<a href='javascript:getSkillSet("+fields[0]+")'>"+fields[i]+"</a>";
//            }
 ...
 if(flag == 1)
     {
         ...
         {
           document.getElementById('ActiveProjects').checked=false;  
