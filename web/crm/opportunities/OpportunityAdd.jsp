         ...
         <s:textfield name="title" cssClass="inputTextBlueLarge1" value="%{currentOpportunity.title}" onchange="fieldLengthValidator(this);changeCase(this);"  id="opportunity" size="50"/> 
                                                       ...
                                                       <%--       <td class="fieldLabel"> Architect :&nbsp; </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td  > 
                                                                <s:select name="type" id="type" cssClass="inputSelect" list="typeList" emptyOption="false" headerKey="-1" headerValue="--Please Select--" value="%{currentOpportunity.type}"/>
                                                        ...
                                                        <tr>
                                                            <td class="fieldLabel">Practice Sales:&nbsp; </td>
                                                            <td > 
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <td> 
                                                                <s:textfield name="value" id="value" cssClass="inputTextBlue" value="%{currentOpportunity.value}" onchange="validatenumber(this);"/> 
                                                            </td>
