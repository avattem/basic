                                            ...
                                            <table border="0" cellpadding="1" cellspacing="1" width="100%">
                                                ...
                                                <s:if test="#session.roleName != 'Vendor'">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><s:select list="industryList" name="industry" id="industry" headerKey="" headerValue="-- Select --" cssClass="inputSelectExtraLarge" value="%{industry}"/></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><s:textfield name="zip" id="zip" cssClass="inputTextBlue" value="%{zip}" onchange="fieldLengthValidator(this);" disabled="false"/>
                                                        </td>    
                                                    </tr>
                                                    <tr>
