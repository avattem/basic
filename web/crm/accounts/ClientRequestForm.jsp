                                ...
                                <table align="center" border="0" cellspacing="0" style="width:100%;">
                                    ...
                                    <div id="libraryAdd" class="tabcontent"  >
                                                ...
                                                <tr align="right">
                                                    ...
                                                    <td class="headerText" colspan="4">
                                                        ...
                                                        <s:if test="#session.roleId == 10">
                                                              <a href="<s:url value="clientReqEngagementPreSalesSearch.action"/>" style="align:center;">
                                        ...
                                        &nbsp;&nbsp;
                                                        ...
                                                        <s:else>
                                                         <a href="<s:url value="clientReqEngagementSearch.action"/>" style="align:center;">
                                            <img alt="Back to List"
                                                 src="<s:url value="/includes/images/backToList_66x19.gif"/>" 
                                                 width="66px" 
                                                 height="19px"
                                    ...
                                    <tr>
                                               ...
                                               <td class="fieldLabel" >RVP Region/ RVP Name:<FONT color="red"  ><em>*</em></FONT> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td > <s:textfield name="customerName" id="customerName" value="%{customerName}" cssClass="inputTextBlue"  theme="simple" onkeyup="fillCustomer();"/>
                                                     ...
                                                     <td class="fieldLabel">Opportunities:<FONT color="red"  ><em>*</em></FONT></td>
                                                    <td>
                                            ...
                                            <tr>
                                                 <td class="fieldLabel">Company Revenue:<FONT color="red"  ><em>*</em></FONT></td>
                                                    <td align="left">
                                                          <s:textfield name="revenues" id="revenues" value="%{revenues}" cssClass="inputTextBlue" readOnly="true" theme="simple"/>
                                                        
                                                           </td>
                                                 <td class="fieldLabel">Size:<FONT color="red"  ><em>*</em></FONT></td>
                                                    <td align="left">
                                                          <s:textfield name="noOfEmployees" id="noOfEmployees" value="%{noOfEmployees}" cssClass="inputTextBlue" readOnly="true"  theme="simple"/>
                                                           </td>
                                            </tr>
                                            <tr>
                                                   <%--  <td class="fieldLabel">Stage:<FONT color="red"  ><em>*</em></FONT></td>
                                                    ...
                                                    <td  align="left">
                                                     ...
                                                     <td class="fieldLabel">BDM :<FONT color="red"  ><em>*</em></FONT></td>
                                                    <td colspan="3" align="left">
