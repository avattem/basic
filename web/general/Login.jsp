                                        ...
                                        <table id="login" bgcolor="#ffffff" border="0" height="150px" width="340px;" align="left" cellpadding="0" cellspacing="2" class="border">
                                            ...
                                            <tr>
                                                <td align="center" colspan="2">
                                                    <a href="<s:url value="/general/registration.action"/>" cssClass="noUnderLine" onmouseover="fixedtooltip('<b>Get Registered Here To Access Hubble .</b>',this,event, 150,2,-60)" onmouseout="delayhidetip()">
