                                                      ...
                                                      <table border="0">
                                                          ...
                                                          <tr> <td class="fieldLabel">ExamType :<font color="red">*</font></td>
                                                              ...
                                                              <td> <s:if test="%{currentAction == 'doAddMcertSubTopics'}">
                                                                      <s:textfield name="examType" value="" cssClass="inputTextHours" id="examType" size="1" onblur="return validateExamType();"/>
                                                                  </s:if>
                                                                  <s:else>
                                                                      <s:textfield name="examType" value="%{examType}" cssClass="inputTextHours" id="examType" size="1" readonly="true"/>
                                                                  </s:else>
