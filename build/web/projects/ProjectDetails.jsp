                                                ...
                                                <s:form name="frmProjectEdit" action="editProject" theme="simple" onsubmit="return projectValidation();">
                                                    ...
                                                    <table cellpadding="1" cellspacing="1" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td > 
                                                                <s:select name="costModel" id="costModel" cssClass="inputSelect" list="{'Fixed','Time & Material'}" emptyOption="false" headerKey="-1" headerValue="--Please Select--" value="%{currentProject.costModel}" />
                                                            </td>
