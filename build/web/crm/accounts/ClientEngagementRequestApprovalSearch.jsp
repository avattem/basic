                            ...
                            <td width="850px" class="cellBorder" valign="top" style="padding:10px 5px 5px 5px;">
                                ...
                                <div  style="border:1px solid gray; width:845px;height: 530px; overflow:auto; margin-bottom: 1em;">
                                    ...
                                    <%--  <sx:div id="List" label="" cssStyle="overflow:auto;"> --%>
                                                 ...
                                                 <s:form name="frmClientReqEngagementApprovalsSearch"  action="clientReqEngagementApprovalsSearch.action" theme="simple" >
                                            ...
                                            <tr>
                                                 <td class="fieldLabel">State:</td>
                                                    <td>
                                                            <s:select id="requestStage" name="requestStage" value="%{requestStage}" list="{'Creation','Submitted','Reviewed','Approved','Rejected'}" cssClass="inputSelect" headerKey="" headerValue="All"/>
                                                    </td>
...
<s:if test="%{requestType=='RFP'}"> 
                                        ...
                                        <grd:imagecolumn headerText="Edit" width="4" HAlign="center" imageSrc="../../includes/images/DBGrid/newEdit_17x18.png"
                                                         linkUrl="getClientEngagementApprovalDetails.action?requestId={Id}" imageBorder="0"
                                                        ...
                                                        <grd:textcolumn dataField="State"  headerText="State"  width="15" /> 
                                                           ...
                                                           <grd:textcolumn dataField="RequestType"  headerText="RequestType"   width="12" /> 
                                        ...
                                        <grd:imagecolumn headerText="Edit" width="4" HAlign="center" imageSrc="../../includes/images/DBGrid/newEdit_17x18.png"
                                                 ...
                                                 <grd:anchorcolumn dataField="Comments" 
                                                   ...
                                                   <s:hidden name="requestType" value="%{requestType}"/>
                                                    <s:hidden name="requestStage" value="%{requestStage}"/>
                                                </td>
                                            </tr>
                                        </table>                                
