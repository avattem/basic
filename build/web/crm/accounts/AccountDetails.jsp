...
function enableConatctEnter(e) {
 ...
 <body class="bodyGeneral" oncontextmenu="return false;" onload="getContactsList();checkCountry(); getActivityList(); getLeadDetailsList();getOpportunityList();getRequirementList();">
                                            ...
                                            <table cellpadding="1"  cellspacing="1" border="0" width="100%">
                                                ...
                                                <s:if test="#session.roleName != 'Vendor'">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><s:textfield name="revenues" id="revenues" cssClass="inputTextBlue"  value="%{currentAccount.revenues}" onblur="return validatenumber(this)"/></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><s:textfield name="iBMPPANo" cssClass="inputTextBlue"  onchange="fieldLengthValidator(this);" size="40" id="iBMPPANo" value="%{currentAccount.iBMPPANo}"/></td>
