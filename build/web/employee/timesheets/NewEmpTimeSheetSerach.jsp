...
<body class="bodyGeneral"  oncontextmenu="return false;" onload="showDefault();init();" >
                                ...
                                <td>
                                    ...
                                    --%>
                                     <td class="fieldLabel" >Projects: </td>
                                        <td >
                                               <s:select list="projectMap" name="projectId" id="projectId" onchange="isOprDualReportsTo(this);getEmployeesByProjectId('search');" headerKey="-1" headerValue="--Select Project--" cssClass="inputSelect" value="%{projectId}" disabled="false"/> 
