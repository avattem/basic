                                                    ...
                                                    <td>
                                                        <table width="80%" border="0" cellspacing="0" cellpadding="0"  align="center">      
                                                            ...
                                                            <tr class="fieldLabel"> 
                                                                ...
                                                                <td width="27%" height="22" align="left"><s:property value="%{empName}"/>
                                                        ...
                                                        <table width="90%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                                                            ...
                                                            <TR>
                                                                ...
                                                                <TD colspan=2 rowspan=2 ALIGN="right" ><s:textarea id="txtNotes"  name="txtNotes" 
                                                                                                                    rows="3" cols="70" cssClass="inputTextarea" value="%{timeSheetVTO.notes}" onchange="fieldLengthValidator(this);"></s:textarea></TD>
                                                            </TR>
                                                            <TR>
                                                            ...
                                                            <TR>
                                                                ...
                                                                <TD Width=40 align=left ><s:textfield   readonly="true" cssClass="inputTextHours" id="totalComptimeHrs" name="totalComptimeHrs" size="5"  value="%{timeSheetVTO.totalComptimeHrs}" /> </TD>
                                                            </TR>  
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center">
                                                                ...
                                                                <s:submit cssClass="buttonBg" value="Back" onclick='document.frmAddTimeSheet.action="newtimeSheet.action"'  />
                                                                <s:hidden name="tempVar" id="tempVar" value=""/>
                                                            </td><td> <div id="attachmentTR" style="display: none;"> <s:if test="%{fileFlagValue==0}"> <a href='#' onclick="uploadTimeSheetAttachement();"><img SRC='../../includes/images/Browse.png' WIDTH=25 HEIGHT=25 BORDER=0 ALTER='' title="Upload Attachment" style="margin-bottom: -5px;"/></a> </s:if> <s:elseif test="%{fileFlagValue==1}"> <a style='color:#C00067;' href='#' onclick='getTimeSheetAttachementDownload();'><img SRC='../../includes/images/DownloadFile.jpg' WIDTH=30 HEIGHT=30 BORDER=0 ALTER='' title="To Download Attachment click on this button" style=" margin-bottom:-5px;"/></a>  <a style='color:#C00067;' href='#' onclick='removeTimeSheetAttachement();'><img SRC='../../includes/images/FileRemove.png' WIDTH=18 HEIGHT=15 BORDER=0 ALTER='' title="To Remove Attachment click on this button"/></a> </s:elseif> </div> </td>
                                                        </tr>
                                                        <tr>
                                                            <td><font color="red" size="2px" face="arial">*Note: After submitting this time sheet you can't edit again.</font></td>
                                                        </tr>
