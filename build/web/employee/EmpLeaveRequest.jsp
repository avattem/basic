...
<td>
    <table class="innerTableLogin" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <table>
                <tr><td> <font class="fieldLabel">Employee Name :</font><font size="2px" color="green" > <s:property value="#request.empName"/></font></td></tr>
                <tr>
            </table>
            ...
            <tr class="headerText" align="right">
                <td colspan="4">
                    ...
                    <s:if test="#request.currentAction != 'editLeave'">
                <s:submit name="submit" value="save" cssClass="buttonBg"/></s:if></td>
        ...
        <tr>
            ...
            <td colspan="2"><s:textarea name="reason" id="reason" cssClass="inputTextarea"  value="%{currentLeave.reason}" onchange="fieldLengthValidator(this);" cols="60" rows="5" /> </td>
        </tr>
        <tr>
