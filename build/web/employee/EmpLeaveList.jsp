                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <grd:dbgrid id="tblEmpLeaves" name="tblEmpLeaves" width="100" pageSize="19" 
                                                            ...
                                                            <grd:datecolumn dataField="StartDate"  headerText="StartDate"  dataFormat="MM-dd-yyyy HH:mm:SS" width="18" sortable="true"/>
                                                            <grd:datecolumn dataField="EndDate"  headerText="EndDate"  dataFormat="MM-dd-yyyy HH:mm:SS" width="18" sortable="true"/>
                                        ...
                                        <s:form name="frmSearch" action="leaveSearch" theme="simple" onsubmit="return compareDates(document.getElementById('startDate').value,document.getElementById('endDate').value);">
                                            ...
                                            <table border="0" cellpadding="1" cellspacing="1" width="100%">
                                                ...
                                                <tr><td align="left"><table>                                                    
                                                            ...
                                                            <td><s:textfield name="startDate" id="startDate" cssClass="inputTextBlue"/><a href="javascript:cal1.popup();">
                                                                    <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                 width="20" height="20" border="0"></a></td>
                                                            <td class="fieldLabel">End Date:</td>
                                                            <td><s:textfield name="endDate" id="endDate" cssClass="inputTextBlue"/><a href="javascript:cal2.popup();">
                                                                    <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                 width="20" height="20" border="0"></a></td>
                                                            <td>
