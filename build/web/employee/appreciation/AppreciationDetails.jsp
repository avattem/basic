...
<html>
    <head>
        ...
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/appreciation/EmployeeAppreciation.js"/>"></script>
    ...
    <s:if test="status=='Send'">
        <body class="bodyGeneral" onload="init();">
       
        </s:if>
        <s:elseif test="%{currentAction=='doAddAppreciation'}">
        <body class="bodyGeneral" onload="addContentDetails();">
        </s:elseif>
        <s:else>
                                        ...
                                        <s:form name="frmAppreciation" id="frmAppreciation" action="%{currentAction}" theme="simple" method="POST" enctype="multipart/form-data" onsubmit="return surveyFieldsValidate();">
                                            <table cellpadding="2" cellspacing="0" border="0" width="100%">                                                
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3"><s:textfield name="appreciationTitle" id="appreciationTitle" required="true"  cssClass="inputTextBlueLargeAccount" onchange="javascript:fieldLenghtValidator(this);" cssStyle="width: 589px; height: 20px" value="%{appreciationTitle}"/>
<!--                                                        <a href="#" class="tooltip">  <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/information.png" width="15px" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3"><s:textfield name="subAppreciationTitle" id="subAppreciationTitle" required="true"  cssClass="inputTextBlueLargeAccount" onchange="javascript:fieldLenghtValidator(this);" cssStyle="width: 589px; height: 20px" value="%{subAppreciationTitle}"/>
<!--                                                        <a href="#" class="tooltip">  <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/information.png" width="15px" 
                                                                                           height="15px" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3"><s:textfield name="appreciationSubject" id="appreciationSubject" required="true" cssClass="inputTextBlueLargeAccount" onchange="javascript:fieldLenghtValidator(this);" cssStyle="width: 589px; height: 20px" value="%{appreciationSubject}" />
<!--                                                        <a href="#" class="tooltip">  <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/information.png" width="15px" 
                                                                                           height="15px" />
                                             ...
                                             <s:if test="%{searchflag == 'my'}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" valign="top"><s:textarea rows="5" cols="65" name="appreciationBodyContent" required="true" cssClass="inputTextareaOverlay1" id="appreciationBodyContent" style="width: 589px; height: 150px" value="%{appreciationBodyContent}" onchange="javascript:fieldLenghtValidator(this);" />
<!--                                                        <a href="#" class="tooltip">  <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/information.png" width="15px" 
                                                                                           height="15px" />
