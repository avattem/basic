                                        ...
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                <td>
                                                    <br><br>
                                                    <table style="width:70%;margin-top:-25px;">
                                                         <div id="leavesUploadResultMessage" style="font-size: 15px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="">
                                                                <input type="file" id="file" name="file" class="browseButtonStyle" onchange="putFileName();"/> 
                                                            </td>
...
<script type="text/JavaScript" src="<s:url value="/includes/javascripts/payroll/payrollajaxscript.js?version=1.1"/>"></script>
    <script type="text/JavaScript" src="<s:url value="/includes/javascripts/payroll/payrollclientvalidations.js"/>"></script>
