...
<html>
    <head>
        ...
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/payroll/payrollCheckAjaxUtill.js"/>"></script>
        ...
        <body  class="bodyGeneral" onload="javascript:animatedcollapse.show('LockAmountCheckDiv');init();" oncontextmenu="return false;">
        </s:if>
        <s:elseif test="%{tempFlag == 2}">
        <body  class="bodyGeneral" onload="javascript:animatedcollapse.show('pfProfessionalTaxReportsDiv')" oncontextmenu="return false;">
        </s:elseif>
        <s:else>
        <body  class="bodyGeneral" onload="javascript:animatedcollapse.show('PayrollCheckExcelReportDiv');init();initWage();initTef();" oncontextmenu="return false;">
