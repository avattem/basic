...
<html>
    ...
    <script type="text/JavaScript" src="<s:url value="/includes/javascripts/payroll/payrollcaliculations_v1.js"/>"></script>
                                                ...
                                                <tr><td colspan="4">
                                                        <table style="width:80%;" align="center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield id="overlayApprovedAmount" name="approvedAmount" cssClass="inputTextBlue" value="%{}" onkeyup="isNumberKey(this);" onchange=""/>
                                                                    <s:hidden id="overlayApprovedAmountHidden" name="overlayApprovedAmountHidden" cssClass="inputTextBlue" value="%{}" onkeyup="isNumberKey(this);" onchange=""/>
                                                            ...
                                                            <div style="margin-right: 7%;">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div id="save">
                                                                                <input type="button" class="btnPayrollWage" value="Save All" id="save00" onclick="addPayrollDetails();" tabindex="22"/>
                                                                            </div>
                                                                            <div id="update" >
                                                                                <input type="button" class="btnPayrollWage" id="update00" value="Update All" onclick="addPayrollDetails();" tabindex="22"/>
                                                                            </div>
                                                                        </td>
                                                                          <td>
...
<td class="fieldLabelWages"  align="right" >Classification&nbsp;:</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><s:textfield name="itgBatch" id="itgBatch" cssClass="inputTextBlueWages" value="%{itgBatch}" onchange=""  tabindex=""/></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><s:textfield name="dateOfEmployement" id="dateOfEmployement" cssClass="inputTextBlueWages" value="%{dateOfEmployement}" onchange="isValidDate(this)" tabindex=""/><a href="javascript:cal1.popup();">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="fieldLabelWages"  align="">Date&nbsp;Of&nbsp;Termination&nbsp;:</td>

                                                                                <td><s:textfield name="dateOfTermination" id="dateOfTermination" cssClass="inputTextBlueWages" value="%{dateOfTermination}" onchange="isValidDate(this)" tabindex=""/><a href="javascript:cal4.popup();">
                                                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                                                             width="20" height="20" border="0"></td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan="5"><s:textarea name="payRollComments" id="payRollComments" cols="85" rows="3" cssClass="inputTextArea" value="%{payRollComments}" onchange="" tabindex=""/></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                            ...
                                                                                                            <div style="margin-right: 7%;">
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td >
                                                                                                                            <div id="save1" >
                                                                                                                                <input type="button" class="btnPayrollWage" value="Save All" id="save11" onclick="addPayrollDetails();" tabindex="36"/>
                                                                                                                            </div>
                                                                                                                            <div id="update1" >
                                                                                                                                <input type="button" class="btnPayrollWage" id="update11" value="Update All" onclick="addPayrollDetails();" tabindex="36"/>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                          <td>
                                            <input type="button" class="btnPayrollWage" value="Cancel" onclick="window.location.href=window.location.href"  tabindex="24"/>
                                                                                                            ...
                                                                                                            <div style="margin-right: -7%;">
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <div id="update2" >
                                                                                                                                <input type="button" class="btnPayrollWage" id="update22" value="Update All" onclick="addPayrollDetails();" tabindex="65"/>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                          <td>
                                            <input type="button" class="btnPayrollWage" value="Cancel" onclick="window.location.href=window.location.href"  tabindex="24"/>
                                                                                                        ...
                                                                                                        <td colspan="6">
                                                                                                            <table cellpadding="1" cellspacing="1" border="0"  align="left"  width="100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td><s:textfield name="basic" id="basic" cssClass="inputTextBluePayroll" value="%{basic}"  onchange="payRollFieldLengthValidator(this);BasicChangeCheck();" onkeyup="isNumberKey(this);" tabindex="38"/></td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td><s:textfield name="ta" id="ta" cssClass="inputTextBluePayroll" value="%{ta}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="39"/></td>
                                                                                                                    <td class="fieldLabelWages" align="right">Employer&nbsp;PF&nbsp;:</td>    
                                                                                                                    <td><s:textfield name="employerPf" id="employerPf" cssClass="inputTextReadOnlyPayroll" value="%{employerPf}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" readonly="true"/></td>
                                                                                                                </tr><tr>  
                                                                                                                    <td class="fieldLabelWages"  align="right">RA:</td>    
                                                                                                                    <td><s:textfield name="ra" id="ra" cssClass="inputTextBluePayroll" value="%{ra}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="40"/></td>
                                                                                                                    <td class="fieldLabelWages" align="right">Employee&nbsp;PF&nbsp;:</td>    
                                                                                                                    <td><s:textfield name="employeePf" id="employeePf" cssClass="inputTextReadOnlyPayroll" readonly="true"  value="%{employeePf}"  onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="57" /></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">Entertainment:</td>    
                                                                                                                    <td><s:textfield name="entertainment" id="entertainment" cssClass="inputTextBluePayroll"  value="%{entertainment}"  onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="41"/></td>
                                                                                                                    <td class="fieldLabelWages" align="right">Employer&nbsp;ESI&nbsp;:</td>    
                                                                                                                    <td><s:textfield name="employeresi" id="employeresi" cssClass="inputTextReadOnlyPayroll" readonly="true"  value="%{employeresi}"  onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="58"  /></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">Kids&nbsp;Education:</td>    
                                                                                                                    <td><s:textfield name="kidsEducation" id="kidsEducation" cssClass="inputTextBluePayroll" value="%{kidsEducation}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="42"/></td>
                                                                                                                    <td class="fieldLabelWages" align="right">Employee&nbsp;ESI&nbsp;:</td>    
                                                                                                                    <td><s:textfield name="employeeesi" id="employeeesi" cssClass="inputTextReadOnlyPayroll" readonly="true"  value="%{employeeesi}"  onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="59" /></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">Vehicle&nbsp;Allowance:</td>    
                                                                                                                    <td><s:textfield name="vehicleAllowance" id="vehicleAllowance" cssClass="inputTextBluePayroll" value="%{vehicleAllowance}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="43"/></td>
                                                                                                                        <td class="fieldLabelWages" align="right">Life:</td>    
                                                                                                                    <td><s:textfield name="life" id="life" cssClass="inputTextBluePayroll" value="%{life}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="60"/></td>
                                                                                                               
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">CCA:</td>    
                                                                                                                    <td><s:textfield name="cca" id="cca" cssClass="inputTextBluePayroll" value="%{cca}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="44"/></td>
                                                                                                                                                                   <td class="fieldLabelWages" align="right">Health:</td>    
                                                                                                                    <td><s:textfield name="health" id="health" cssClass="inputTextBluePayroll" value="%{health}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="61"/></td>
                        
                                                                                        </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">Misc&nbsp;Pay:</td>    
                                                                                                                    <td><s:textfield name="miscPay" id="miscPay" cssClass="inputTextBluePayroll" value="%{miscPay}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="45"/></td>
                                                        ...
                                                        <img src="/<%=ApplicationConstants.CONTEXT_PATH%>/includes/images/showCalendar.gif" 
                                                             width="20" height="20" border="0"></td>  --%>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td><s:textfield name="splAllowance" id="splAllowance" cssClass="inputTextBluePayroll" value="%{splAllowance}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="46"/></td>
                                                                                                             </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">LongTermBonus:</td>    
                                                                                                                    <td><s:textfield name="longTermBonus" id="longTermBonus" cssClass="inputTextBluePayroll"  value="%{longTermBonus}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="47"/></td>
                                                                                                                 <td class="fieldLabelWages" align="right">Base&nbsp;Pay:</td>    
                                                                                                                   ...
                                                                                                                   <%--   <td class="fieldLabelWages" align="right">Other&nbsp;Deductions:</td>   --%> 
                                                                                                                    <td><s:hidden name="otherDeductions" id="otherDeductions" cssClass="inputTextBluePayroll" value="%{otherDeductions}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="62"/></td> 
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">Project&nbsp;Pay:</td>    
                                                                                                                    <td><s:textfield name="projectPay" id="projectPay" cssClass="inputTextBluePayroll"  value="%{projectPay}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="48"/></td>
                                                                                                                     <td class="fieldLabelWages" align="right">Variable&nbsp;Pay:</td>    
                                                                                                                    <td><s:textfield name="variablePay" id="variablePay" cssClass="inputTextReadOnlyImpPayroll" value="%{variablePay}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" readonly="true"/></td>
                                                                                                                <%-- <td class="fieldLabelWages" align="right">Net&nbsp;Paid:</td>    --%>
                                                                                                                     <td><s:hidden name="netPaidPayroll" id="netPaidPayroll" value="%{netPaidPayroll}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" readonly="true"/>

                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="fieldLabelWages"  align="right">Attendance&nbsp;Allow:</td>    
                                                                                                                    <td><s:textfield name="attendanceAllow" id="attendanceAllow" cssClass="inputTextBluePayroll" value="%{attendanceAllow}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="49"/></td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td><s:textfield name="totalCost" id="totalCost" cssClass="inputTextReadOnlyTotalCostPayroll" readonly="true" value="%{totalCost}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="63"/>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td >  <s:checkbox name="onsiteInd" id="onsiteInd"
                                                                                                                        ...
                                                                                                                        <s:textfield name="onsiteIndV" id="onsiteIndV" cssClass="inputTextBluePayroll" value="%{onsiteIndV}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" readonly=" " tabindex="53"/></td>
                                                                                                                    ...
                                                                                                                    <td><s:textfield name="datePayRevised" id="datePayRevised" cssClass="inputTextBluePayroll" value="%{datePayRevised}" onchange="isValidDate(this)" tabindex="64"/>
                                                                                                                        <a href="javascript:cal3.popup();">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td><s:textfield name="diffPF" id="diffPF" cssClass="inputTextBluePayroll" value="%{diffPF}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex=""/>
                                                                                                                                                ...
                                                                                                                                                <td colspan="5">
                                                                                                                                                    <table>
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            ...
                                                                                                                                                            <td colspan="4"><s:textfield  cssClass="inputTextBluePayroll" name="totalCostCalc" id="totalCostCalc" value="%{totalCost}" size="8" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);"/></td>
                                                                                                                                                        </tr>

                                                                                                                                                        <tr>
                                                                                                                                                            <td class="fieldLabelWages">LongTermBonus:</td>
                                                                                                                                                            <td colspan="4"> <s:textfield  cssClass="inputTextBluePayroll"  name="longBonusCalc" id="longBonusCalc" value="%{longTermBonus}" size="8" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);"/></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                            <td class="fieldLabelWages">Employer&nbsp;PF :</td>
                                                                                                                                                            <td colspan="4"><s:textfield  cssClass="inputTextBluePayroll" name="employerPfCalc" id="employerPfCalc" value="%{employerPf}"  size="8" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);"/></td>
                                                                                                                                                        </tr>


                                                                                                                                                        <tr>
                                                                                                                                                            <td class="fieldLabelWages">Attendance Allow:</td>
                                                                                                                                                            <td colspan="4"> <s:textfield  cssClass="inputTextBluePayroll"  name="attAllowCalc" id="attAllowCalc" value="%{attendanceAllow}" size="8" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);"/></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                            <td class="fieldLabelWages">Health:</td>
                                                                                                                                                            <td colspan="4"> <s:textfield  cssClass="inputTextBluePayroll"  name="healthCalc" id="healthCalc" value="%{health}" size="8" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);"/></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                                                                                            <td class="fieldLabelWages">Professional Tax:</td>
                                                                                                                                                            <td colspan="4"> <s:textfield  cssClass="inputTextBluePayroll"  name="pfTaxCalc" id="pfTaxCalc" value="%{professionalTax}" size="8" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);"/></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                            ...
                                            <input type="button" class="btnPayrollWage" value="Cancel" onclick="window.location.href=window.location.href"  tabindex="24"/>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td colspan="2"><s:textfield name="expectedYearlyCost" id="expectedYearlyCost" cssClass="inputTextReadOnlyPayroll" value="%{expectedYearlyCost}" onchange="" onkeyup="isNumberKey(this);" tabindex="" readonly="true"/></td>               
                                                                                                                        </tr>
                                                                                                                        <%--</tr>
                                                                                                                      <tr>
                                                                        ...
                                                                        <tr>--%>
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td ><s:textfield name="empSaving1" id="empSaving1" cssClass="inputTextReadOnlyPayroll" value="%{empSaving1}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="68" readonly="true"/></td>
                                                                                                                            <td class="fieldLabelWages"  align="left" colspan="3">Interest&nbsp;on&nbsp;House&nbsp;Property(Housing Loan)-24(b)&nbsp;:</td>                           

                                                                                                                            <td ><s:textfield name="empSaving2" id="empSaving2" cssClass="inputTextReadOnlyPayroll" value="%{empSaving2}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="77" readonly="true"/></td>               
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td ><s:textfield name="empSaving3" id="empSaving3" cssClass="inputTextReadOnlyPayroll" value="%{empSaving3}" onchange="" onkeyup="isNumberKey(this);" tabindex="68" readonly="true"/></td>
                                                                                                                            <td class="fieldLabelWages"  align="left" colspan="3">Interest&nbsp;on&nbsp;Education&nbsp;Loan(80E):</td>                           

                                                                                                                            <td ><s:textfield name="empSaving4" id="empSaving4" cssClass="inputTextReadOnlyPayroll" value="%{empSaving4}" onchange="" onkeyup="isNumberKey(this);" tabindex="77" readonly="true"/></td>               


                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                              <td class="fieldLabelWages" align="right"  >NPS&nbsp;(80CCD):</td>
                                                                                                                              <td ><s:textfield name="empSaving6" id="empSaving6" cssClass="inputTextReadOnlyPayroll" value="%{empSaving6}" onchange="" onkeyup="isNumberKey(this);" tabindex="68" readonly="true"/></td>
                                                                                                                         
                                                                                                                            <td class="fieldLabelWages"  align="left" colspan="3" >House&nbsp;Rent&nbsp;Paid-80GG:</td>

                                                                                                                            <td ><s:textfield name="empSaving5" id="empSaving5" cssClass="inputTextReadOnlyPayroll" value="%{empSaving5}" onchange="" onkeyup="isNumberKey(this);" tabindex="68" readonly="true"/></td>
                                                                            ...
                                                                            <td colspan=""><s:textfield name="tutionfees" id="tutionfees" cssClass="inputTextBlueWagesReg" value="%{tutionfees}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="69"/></td>    
                                                                            <td class="fieldLabelWages"  align="left" colspan="3">HB&nbsp;Loan&nbsp;Interest:</td>                           

                                                                            <td ><s:textfield name="hbLoanInterst" id="hbLoanInterst" cssClass="inputTextBlueWagesReg" value="%{hbLoanInterst}" onchange="payRollFieldLengthValidator(this);addToEmpSavings2(this);" onkeyup="isNumberKey(this);" tabindex="78"/></td>               
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan=""><s:textfield name="ppf" id="ppf" cssClass="inputTextBlueWagesReg" value="%{ppf}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="70"/></td>    
                                                                            <td class="fieldLabelWages"  align="left" colspan="3">Medical&nbsp;Ins.:</td>                           

                                                                            <td ><s:textfield name="medicalIns" id="medicalIns" cssClass="inputTextBlueWagesReg" value="%{medicalIns}" onchange="payRollFieldLengthValidator(this);addToEmpSavings2(this);" onkeyup="isNumberKey(this);" tabindex="79"/></td>               
                                                                        </tr>
                                                                        <tr>

                                                                            <td class="fieldLabelWages"  align="right">Life&nbsp;Ins.:</td>                           

                                                                            <td colspan=""><s:textfield name="lifeIns" id="lifeIns" cssClass="inputTextBlueWagesReg" value="%{lifeIns}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="71"/></td>    
                                                                            <td class="fieldLabelWages"  align="left" colspan="3">HRA:</td>                           

                                                                            <td ><s:textfield name="hraLifeInsuranceSavings" id="hraLifeInsuranceSavings" cssClass="inputTextBlueWagesReg" value="%{hraLifeInsuranceSavings}" onchange="payRollFieldLengthValidator(this);addToEmpSavings2(this);" onkeyup="isNumberKey(this);" tabindex="80"/></td>               
                                                                        </tr>
                                                                        <tr>

                                                                            <td class="fieldLabelWages"  align="right" >Premium:</td>                           

                                                                            <td colspan=""><s:textfield name="premium" id="premium" cssClass="inputTextBlueWagesReg" value="%{premium}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="72"/></td>    

                                                                            <td class="fieldLabelWages"  align="left" colspan="3">Edu.&nbsp;Interest:</td>                           

                                                                            <td ><s:textfield name="eduInterest" id="eduInterest" cssClass="inputTextBlueWagesReg" value="%{eduInterest}" onchange="payRollFieldLengthValidator(this);addToEmpSavings2(this);" onkeyup="isNumberKey(this);" tabindex="81"/></td>               
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="fieldLabelWages"  align="right" colspan="">FD:</td>                           

                                                                            <td colspan="5"><s:textfield name="fd" id="fd" cssClass="inputTextBlueWagesReg" value="%{fd}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="73"/></td>    
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="fieldLabelWages"  align="right" colspan="">HB&nbsp;Loan&nbsp;Priciple:</td>                           

                                                                            <td colspan="5"><s:textfield name="hbLoanPrinciple" id="hbLoanPrinciple" cssClass="inputTextBlueWagesReg" value="%{hbLoanPrinciple}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="74"/></td>    
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="fieldLabelWages"  align="right" colspan="">Mutual&nbsp;Funds:</td>                           

                                                                            <td colspan="5"><s:textfield name="mutualFunds" id="mutualFunds" cssClass="inputTextBlueWagesReg" value="%{mutualFunds}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="75"/></td>    
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="fieldLabelWages"  align="right" colspan="">NSC:</td>                           

                                                                            <td colspan="5"><s:textfield name="nsc" id="nsc" cssClass="inputTextBlueWagesReg" value="%{nsc}" onchange="payRollFieldLengthValidator(this);addToEmpSavings1(this);" onkeyup="isNumberKey(this);" tabindex="76"/></td>    
                                                                        </tr>
                                            ...
                                            <input type="button" class="btnPayrollWage" value="Cancel" onclick="window.location.href=window.location.href"  tabindex="24"/>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td ><s:textfield name="noOfLeaves" id="noOfLeaves" cssClass="inputTextReadOnlyPayroll" value="%{noOfLeaves}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="68" readonly="true"/></td>
                                                                                                                            <td class="fieldLabelWages"  align="left" colspan="3">Total&nbsp;No&nbsp;Of&nbsp;Weekends&nbsp;:</td>                           

                                                                                                                            <td ><s:textfield name="noOfWeekendDays" id="noOfWeekendDays" cssClass="inputTextReadOnlyPayroll" value="%{noOfWeekendDays}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="77" readonly="true"/></td>               
                                                                                                                         ...
                                                                                                                         <tr>
                                                                                                                            ...
                                                                                                                            <td ><s:textfield name="availLeaves" id="availLeaves" cssClass="inputTextReadOnlyPayroll" value="%{availLeaves}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="68" readonly="true"/></td>
                                                                                                                            <td class="fieldLabelWages"  align="left" colspan="3">Weekends&nbsp;Balance:</td>                           

                                                                                                                            <td ><s:textfield name="availWeekends" id="availWeekends" cssClass="inputTextReadOnlyPayroll" value="%{availWeekends}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="77" readonly="true"/></td>               
                                                                                                                         ...
                                                                                                                         <tr>
                                                                                                                            ...
                                                                                                                            <td ><s:textfield name="availHolidays" id="availHolidays" cssClass="inputTextReadOnlyPayroll" value="%{availHolidays}" onchange="payRollFieldLengthValidator(this);" onkeyup="isNumberKey(this);" tabindex="68" readonly="true"/></td>
