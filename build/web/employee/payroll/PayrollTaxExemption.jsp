                                                    ...
                                                    <tr><td colspan="4">
                                                            <table align="center" border="0">
                                                               ...
                                                               <%-- <td class="fieldLabel" width="200px" align="right">Department :</td>
                                                                ...
                                                                <s:textfield name="employeeName" id="employeeName" value="" autocomplete="off" cssClass="inputTextBlue" onkeyup="getEmplyeeNames();"/><label id="rejectedId"></label><div class="fieldLabelLeft" id="validationMessage"></div>
                                    ...
                                    <s:form name="frmTaxAssumptionSearch" action="PayrollTaxAssumptionSearch.action" theme="simple" id="nn">
                                        ...
                                        <table cellpadding="1" cellspacing="1" border="0" width="650px" align="center">
                                          ...
                                          <%-- <tr>
                                            ...
                                            <s:textfield name="employeeName" id="employeeName1" value="%{employeeName}" autocomplete="off" cssClass="inputTextBlue" onkeyup="getEmplyeeNamesForTefSearch();"/><span id="empNoSpan"></span><label id="rejectedId"></label><div class="fieldLabelLeft" id="validationMessage1"></div>
...
<script type="text/JavaScript" src="<s:url value="/includes/javascripts/payroll/payrollajaxscript.js?version=2.7"/>"></script>
