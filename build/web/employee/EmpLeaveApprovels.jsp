                                                ...
                                                <tr>
                                                    <td> 
                                                        ...
                                                        <grd:dbgrid id="tblEmpLeaves" name="tblEmpLeaves" width="100" pageSize="15" 
                                                            ...
                                                            <grd:datecolumn dataField="StartDate"  headerText="StartDate" dataFormat="MM-dd-yyyy HH:mm:SS" width="18" sortable="false"/>
                                                            <grd:datecolumn dataField="EndDate"  headerText="EndDate"  dataFormat="MM-dd-yyyy HH:mm:SS" width="18" sortable="false"/>
                                       ...
                                       <s:form name="frmSearch" action="teamMembersLeavesSearch" theme="simple" method="post">
                                            ...
                                            <table border="0" cellpadding="1" cellspacing="1" width="80%" align="center">
                                                <tr> 
                                                    ...
                                                    <td>
                                                    <s:select list="#session.MyTeamMapForLeaveSearch" name="empName" id="empName"  headerValue="select" headerKey="" />
                                                    </td>
