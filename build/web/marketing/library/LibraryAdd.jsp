                                    ...
                                    <div id="libraryAdd" class="tabcontent"  >
                                        ...
                                        &nbsp;&nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <s:if test="%{currentAction=='doAddLibrary'}">
                                                            ...
                                                            <s:select name="resourceType" list="{'Case Study','Technical Article','Product Brief','Solution Brief','Presentation'}" cssClass="inputSelect" headerKey="" headerValue="--Please Select--" onchange="hideBodyContent();" disabled="true"/>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="29%"><s:select id="resourceIndustry" name="resourceIndustry" list="{'Retail','Manufacturing','Health Care','Logistics','Finance and Insurance','Application Development'}" cssClass="inputSelect" headerKey="" headerValue="--Please Select--"/></td>
