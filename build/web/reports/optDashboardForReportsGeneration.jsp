...
<html>
    <head>
       ...
       <link rel="stylesheet" type="text/css" href="<s:url value="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css"/>">
        ...
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/OperationsDashBoardAjax.js?version=2.1"/>"></script>
...
function loadAvailabilityList(){
 ...
 <%--Sales KPI starts--%>
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><s:select name="practiceId1"  id="practiceId1" headerKey="-1" headerValue="--Please Select--" list="practiceIdList" cssClass="inputSelect" /></td>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="fieldLabel" width="200px" align="right">Department :</td>
                                                                                          ...
                                                                                          <td class="fieldLabel" align="right" style="padding: 20px"> <s:checkbox name="ActiveProjects" id="ActiveProjects"
                                                                                                        value="%{ActiveProjects}" theme="simple" tabindex="11" disabled="true"/>: Only Active Projects&nbsp;</td> 
                                            ...
                                            <%-- Project Details by Customer Start  --%>
                                             <s:if test="%{#session.livingCountryList == 'USA' || isAdminFlag=='YES'}"> 
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                         ...
                                                                                         <tr>
                                                                                            ...
                                                                                            <td width="25%">
                                                                                                   <s:select list="myProjects" name="projectId" id="projectId" headerKey="-1" headerValue="--Select Project--" cssClass="inputSelectLarge" disabled="false"/> 
                                                                                            </td>
                                                                                             </tr>
                                                                                        <tr>
                                                                                            <td colspan="3"></td>
