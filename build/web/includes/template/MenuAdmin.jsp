...
<html lang=''>
    ...
    <script type="text/javascript" src="<s:url value="/includes/javascripts/reviews/jquery.js"/>"></script>  
        <script type="text/JavaScript" src="<s:url value="/includes/javascripts/menu/MenuAdmin.js"/>"></script>
                ...
                <li class='has-sub'  ><a href='#' id="iconToggleServices"> <span id="servicesAdmin">Services</span></a>
                    <ul id="servicesDisplay">
                     ...
                     <%--   <li><a id="servicesEmpReport" href="/<%=ApplicationConstants.CONTEXT_PATH%>/reports/employeeReports.action"><span>Emp Report</span></a></li> --%>
                        ...
                        <li class='last'><a id="servicesExcelUpload" href="/<%=ApplicationConstants.CONTEXT_PATH%>/crm/accounts/excelUpload.action"><span>Accounts&nbsp;Excel&nbsp;Upload</span></a></li>
                    </ul>
                     </li>
            </ul>
