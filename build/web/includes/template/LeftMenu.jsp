...
<%--
<div id="button" style="width=150px;height=100%;">
<ul>
<s:iterator value="#session.leftMenu">
<li><a href="<s:url value="%{screenAction}"/>"><s:property value="screenTitle"/></a></li>
</s:iterator>        
<li><a id="mailid" href="#" onclick="return win_open('../../services/mail/MailWindow.jsp');">--> Mail Service</a></li>
</ul>
</div>
--%>
