...
<html>
  ...
  <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css">
   ...
   <body>
	<header class="header-search" style="border-bottom-color:black">
<div class="header-qa">
<img src="images/qa.png" style="height: 204px;
    margin-bottom: -44px;
   margin-left: -6px;
    margin-top: -72px;
    width: 246px;"/>
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        ...
        <div class="login-form" id="myLogin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<p id="wrapper" class="frgt_pwd"><a  class="slide_open" href="" id="closeLogin" data-dismiss="modal" data-toggle="modal" data-target="#forgotPwd"><font class ="fgtPwd" style="float:right">Forgot password?</font></a></p>
