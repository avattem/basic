...
<nav>
		...
		<section id="body" class="width clear">
			...
			<section  id="content" class="column-right">
			  <article>
<form action="${pageContext.request.contextPath}/namesInSelectBox.qa" method="post">
			
   <!--  <select id="sbOne" name="sbOne" multiple="multiple" disabled="disabled">
  ...
  -->
    <select id="sbTwo" name="sbTwo" multiple="multiple">
