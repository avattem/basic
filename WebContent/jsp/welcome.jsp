  ...
  <div id="slides">
	...
	<li class="slide">
        <div class="quoteContainer">
          <p class="quote-phrase"><span class="quote-marks">"</span>Miracle's QA framework assist auditors (testers) to perform automation, performance, security type of audits for web applications using standard frameworks available in IT industry.<span class="quote-marks">"</span> </p>
        </div>
       
      </li>
      <li class="slide">
        <div class="quoteContainer">
          <p class="quote-phrase"><span class="quote-marks">"</span>It is quality rather than quantity that counts
							
<span class="quote-marks">"</span> </p>
        </div>
      ...
      <li class="slide">
        <div class="quoteContainer">
          <p class="quote-phrase"><span class="quote-marks">"</span> Give quality to client, that's best kind of advertising.<span class="quote-marks">"</span> </p>
        </div>
		<div class="authorContainer">
      ...
      <li class="slide">
        <div class="quoteContainer">
          <p class="quote-phrase"><span class="quote-marks">"</span>A code that cannot be tested is flawed.<span class="quote-marks">"</span> </p>
        </div>
	    ...
	    <article>
			...
			<div class="modal-content">
                                            <div class="modal-header " style="background: rgba(0, 0, 0, 0) linear-gradient(#00aae7, #0d416b) repeat scroll 0 0;; border-top-right-radius: 0px; border-top-left-radius: 0px;">
                                               
                                                <h4 class="modal-title" id="myModalLabel" style="color:white">Recent Activity</h4>
                                            </div>
...
<%
			...
			{link=repFolder;
       					  %>
       					 <a href="${pageContext.request.contextPath}/download.qa?selectedValue=<%=link%>"><%=link.substring(link.lastIndexOf("\\")+1)%> </a></h4>
   				       <%} 
   				       else
			{
